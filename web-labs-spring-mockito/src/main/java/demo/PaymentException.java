...
public class PaymentException extends RuntimeException {
	...
	public static enum PaymentErrors {
		...
		COULD_NOT_GET_EXCHANGE_RATE,
		TRANSFER_COULD_NOT_BE_PROCESSED
	}
	...
	public static PaymentException couldNotGetExchangeRate() {
		return new PaymentException(PaymentErrors.COULD_NOT_GET_EXCHANGE_RATE);
	}
	
	public static PaymentException transferCouldNotBeProcessed() {
		return new PaymentException(PaymentErrors.TRANSFER_COULD_NOT_BE_PROCESSED);
	}
